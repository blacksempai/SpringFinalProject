...
-- Schema taxes_outdated
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema taxes_outdated
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `taxes_outdated` DEFAULT CHARACTER SET utf8 ;
USE `taxes_outdated` ;

-- -----------------------------------------------------
-- Table `taxes_outdated`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`account` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`admin` (
  `account_id` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`account_id`),
  UNIQUE INDEX `admin_id_UNIQUE` (`account_id` ASC) VISIBLE,
  CONSTRAINT `admin_account`
    FOREIGN KEY (`account_id`)
    REFERENCES `taxes_outdated`.`account` (`account_id`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
ENGINE = InnoDB
AUTO_INCREMENT = 47
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`report_general`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`report_general` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`business_activity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`business_activity` (
  ...
  CONSTRAINT `id`
    ...
    REFERENCES `taxes_outdated`.`report_general` (`report_general_id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 21
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`first_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`first_group` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`inspector`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`inspector` (
  `account_id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`report_errors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`report_errors` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`report_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`report_info` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`second_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`second_group` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`third_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`third_group` (
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`report_body`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`report_body` (
  ...
  CONSTRAINT `error_id`
    ...
    REFERENCES `taxes_outdated`.`report_errors` (`report_errors_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `first_group_id`
    FOREIGN KEY (`first_group_id`)
    REFERENCES `taxes_outdated`.`first_group` (`first_group_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  ...
  CONSTRAINT `info_id`
    FOREIGN KEY (`info_id`)
    REFERENCES `taxes_outdated`.`report_info` (`report_info_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `second_group_id`
    FOREIGN KEY (`second_group_id`)
    REFERENCES `taxes_outdated`.`second_group` (`second_group_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `third_group_id`
    FOREIGN KEY (`third_group_id`)
    REFERENCES `taxes_outdated`.`third_group` (`third_group_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 26
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`user` (
  `account_id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `taxes_outdated`.`report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taxes_outdated`.`report` (
  ...
  CONSTRAINT `body_id`
    FOREIGN KEY (`body_id`)
    REFERENCES `taxes_outdated`.`report_body` (`report_body_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `inspector_id`
    FOREIGN KEY (`inspector_id`)
    REFERENCES `taxes_outdated`.`inspector` (`account_id`),
  CONSTRAINT `user_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `taxes_outdated`.`user` (`account_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 30
DEFAULT CHARACTER SET = utf8;
