...
import com.javacourse.model.entities.report.Info;
import com.javacourse.model.entities.report.Report;
import com.javacourse.model.entities.report.ReportBody;

import java.util.List;

public class TaxReportSummaryCalculator {
    public static TaxReportSummary calculateSummary(Report report, DAOFactory factory){
    ...
    public static double calculatePreviousTotalSum(Report report, DAOFactory factory){
        Report previousReport = getPreviousReport(report,factory);
    ...
    public static Report getPreviousReport(Report report, DAOFactory factory){
        Report previousReport = null;
        ReportDAO reportDAO = factory.createReportDAO();
        List<Report> reports = reportDAO.getReportsByUser(report.getUser());
        long reportDate = 0;
